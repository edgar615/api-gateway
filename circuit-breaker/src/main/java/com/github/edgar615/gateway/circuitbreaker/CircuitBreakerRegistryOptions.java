...
public class CircuitBreakerRegistryOptions extends CircuitBreakerOptions {
  ...
  private static final String DEFAULT_ANNOUNCE = "__com.github.edgar615.gateway.circuitbreaker.announce";
   ...
   * stateAnnounce：广播地址，断路器状态变化后的会向这个地址发送广播.，默认：__com.github.edgar615.gateway.circuitbreaker.announce
   *
   * @param json 断路器的配置
   * @return
   */
