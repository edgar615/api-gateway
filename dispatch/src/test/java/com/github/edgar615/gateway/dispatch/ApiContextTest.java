...
public class ApiContextTest {
    ...
    public void testDeleteTwoParam(TestContext testContext) {
        ...
        vertx.createHttpClient()
                .delete(port, host, "/delete_two_param?limit=10&start=1", response -> {
                    response.bodyHandler(body -> {
                        System.out.println(body);
                        async.complete();
                    });
    ...
    public void testPostInvaidJson(TestContext testContext) {
        Async async = testContext.async();
        vertx.createHttpClient()
                .post(port, host, "/post_invalid_json?limit=10&start=1", response -> {
                    response.bodyHandler(body -> {
                        System.out.println(body);
                        async.complete();
                    });
    ...
    private void assertDeleteNoParam(TestContext context, RoutingContext rc,
    ...
    private void assertDeleteTwoParam(TestContext context, RoutingContext rc,
                                      ApiContext apiContext) {
    ...
    private void assertPostInvaidJson(TestContext context, RoutingContext rc,
                                      ApiContext apiContext) {
