...
import com.github.edgar615.gateway.circuitbreaker.CircuitBreakerRegistry;
import com.github.edgar615.gateway.circuitbreaker.CircuitBreakerRegistryOptions;
import com.github.edgar615.gateway.core.dispatch.ApiContext;
import com.github.edgar615.gateway.core.dispatch.Filter;
import com.github.edgar615.gateway.core.rpc.CircuitBreakerExecutable;
import com.github.edgar615.gateway.core.rpc.FailureRpcHandler;
        ...
        circuitBreakerFuture.setHandler(ar -> {
            if (ar.failed()) {
                if (ar.cause() instanceof NoStackTraceThrowable
                    ...
                    LOGGER.error("[{}] [{}] [{}]", traceId, RpcFilter.class.getSimpleName(),
                                 "timeout");
