 ...
 */
public class IpRestrictionPluginTest {
  ...
  public void testDecode() {
    ...
    ApiPluginFactory<IpRestrictionPlugin> factory = new IpRestrictionFactory();
    IpRestrictionPlugin ip = factory.decode(new JsonObject()
  ...
  public void testEncode() {
    ApiPlugin plugin = ApiPlugin.create(IpRestrictionPlugin
        .class.getSimpleName());
    IpRestrictionPlugin ip = (IpRestrictionPlugin) plugin;
