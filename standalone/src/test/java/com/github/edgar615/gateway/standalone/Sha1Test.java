...
public class Sha1Test {
    public static void main(String[] args) {
        System.out.println(isValidCallback("{\"ref\":\"refs/heads/master\","
                                           ...
                                           "a15a8a1c0d6df2332d8fe4a8cf777743b3e4ea0f"));
    }

    public static boolean isValidCallback(String callbackBody, String callbackSignature) {

        // Combine your webhook notification URL and the JSON body of the incoming request into a
        // single string
//    String stringToSign = _webhookUrl + callbackBody;
        ...
        // Hash the two signatures a second time (to protect against timing attacks) and compare
        // them
        try {
            MessageDigest digest = MessageDigest.getInstance("SHA-1");
            String hashedCallbackSignature =
                    new String(digest.digest(callbackSignature.getBytes()));
