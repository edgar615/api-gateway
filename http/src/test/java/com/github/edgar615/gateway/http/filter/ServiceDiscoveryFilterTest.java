...
import com.github.edgar615.gateway.http.splitter.ClientIpTraffic;
import com.github.edgar615.gateway.http.splitter.IpPolicy;
import com.github.edgar615.gateway.http.splitter.IpRangePolicy;
...
//    vertx.close(testContext.asyncAssertSuccess());
    ...
    private void add3Servers() {
        mockConsulHttpVerticle.addService(new JsonObject()
                                                  ...
                                                  .put("ServiceName", "device")
                                                  .put("ServiceTags",
                                                       new JsonArray().add("blue").add("blue2"))
                                                  .put("ServicePort", 8080));
        mockConsulHttpVerticle.addService(new JsonObject()
                                                  .put("ID", UUID.randomUUID().toString())
                                                  .put("Node", "u221")
