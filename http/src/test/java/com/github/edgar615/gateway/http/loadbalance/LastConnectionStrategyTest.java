...
public class LastConnectionStrategyTest {
    ...
    public void setUp() {
        ...
        instances.add(HttpEndpoint.createRecord("test", "localhost", 8083, "/")
                              .setRegistration("c"));
        LoadBalanceStats.instance().get("a").incActiveRequests().incActiveRequests()
                .decActiveRequests();
        LoadBalanceStats.instance().get("b").incActiveRequests().decActiveRequests()
                .decActiveRequests();
        LoadBalanceStats.instance().get("c").incActiveRequests().incActiveRequests()
                .incActiveRequests();
    }
