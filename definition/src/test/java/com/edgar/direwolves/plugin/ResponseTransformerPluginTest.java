...
import com.edgar.direwolves.plugin.transformer.*;
...
public class ResponseTransformerPluginTest {
  ...
  public void testDecode() {
    ...
    JsonObject request = new JsonObject()
        .put("name", "add_device")
        .put("response.header.remove", new JsonArray().add("h3").add("h4"))
        .put("response.body.remove", new JsonArray().add("p3").add("p4"))
        .put("response.header.replace", new JsonArray().add("h5:v2").add("h6:v1"))
        .put("response.body.replace", new JsonArray().add("p5:v2").add("p6:v1"))
        .put("response.header.add", new JsonArray().add("h1:v2").add("h2:v1"))
        .put("response.body.add", new JsonArray().add("p1:v2").add("p2:v1"));
