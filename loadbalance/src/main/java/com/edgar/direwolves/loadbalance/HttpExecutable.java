...
//
//  private LoadingCache<String, ServiceProvider> cache;
//
//  protected HttpExecutable(Vertx vertx, ServiceDiscovery discovery, JsonObject config) {
...
//                return ServiceProvider.create(discovery, service);
//              }
//            });
//  }
//
...
//      ServiceProvider provider = ServiceProvider.create(discovery, service);
//      cache.asMap().putIfAbsent(service, provider);
//      return cache.asMap().get(service);
//    }
//  }
//
////  @Override
...
//            .info();
//
//    ServiceProvider provider = getProvider(request.service());
//    provider.choose(ar -> {
//      if (ar.failed()) {
//        Log.create(LOGGER)
//                .setTraceId(request.id())
...
//            httpClient
//                    .request(request.method(), request.port(), request.host(),
//                             path)
...
//                                   duration.duration());
//        Log.create(LOGGER)
//                .setTraceId(httpClientRequest.id())
...
//    });
//    header(httpRpcRequest, httpClientRequest);
//    exceptionHandler(future, httpClientRequest, httpRpcRequest.serverId());
//    timeout(httpRpcRequest, httpClientRequest);
//
//    endRequest(httpRpcRequest, httpClientRequest);
//    return future;
//  }
//
