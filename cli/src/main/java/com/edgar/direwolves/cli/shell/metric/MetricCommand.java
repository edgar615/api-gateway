package com.edgar.direwolves.cli.shell.metric;
 ...
 */
@Name("metric-info")
@Summary("print a metric")
public class MetricCommand extends AnnotatedCommand {
  private static final String ADDRESS = "direwolves.eb.api.metric";
