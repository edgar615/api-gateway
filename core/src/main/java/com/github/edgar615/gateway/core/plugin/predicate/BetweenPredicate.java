...
public class BetweenPredicate implements ApiPredicate {
  ...
  public BetweenPredicate(String startDateTime, String endDateTime) {
    ...
    this.zoneStartDateTime = ZonedDateTime.parse(startDateTime, DateTimeFormatter.ISO_OFFSET_DATE_TIME);
    this.zoneEndDateTime = ZonedDateTime.parse(endDateTime, DateTimeFormatter.ISO_OFFSET_DATE_TIME);
    ;
  }
