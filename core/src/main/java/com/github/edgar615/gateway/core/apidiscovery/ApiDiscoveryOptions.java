...
public class ApiDiscoveryOptions {
  public static final String DEFAULT_PUBLISHED_ADDRESS = "__com.github.edgar615.gateway.api.published";

  public static final String DEFAULT_UNPUBLISHED_ADDRESS = "__com.github.edgar615.gateway.api.unpublished";
