...
public class SomeServiceVertxProxyHandler extends ProxyHandler {
  ...
  public SomeServiceVertxProxyHandler(Vertx vertx, SomeService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public SomeServiceVertxProxyHandler(Vertx vertx, SomeService service, long timeoutInSecond) {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "process": {
          service.process((String)json.getValue("id"), createHandler(msg));
          break;
        }
        default: {
