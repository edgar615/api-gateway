...
public class ApiProviderVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final ApiProvider service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public ApiProviderVertxProxyHandler(Vertx vertx, ApiProvider service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public ApiProviderVertxProxyHandler(Vertx vertx, ApiProvider service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public ApiProviderVertxProxyHandler(Vertx vertx, ApiProvider service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
