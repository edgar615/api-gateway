...
public class CacheProviderVertxProxyHandler extends ProxyHandler {
  ...
  private final CacheProvider service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public CacheProviderVertxProxyHandler(Vertx vertx, CacheProvider service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public CacheProviderVertxProxyHandler(Vertx vertx, CacheProvider service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public CacheProviderVertxProxyHandler(Vertx vertx, CacheProvider service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
