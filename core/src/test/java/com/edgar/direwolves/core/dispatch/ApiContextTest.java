...
public class ApiContextTest {
  ...
  public void testCopyRequest() {
    ...
    HttpRpcRequest rpcRequest = HttpRpcRequest.create(UUID.randomUUID().toString(), UUID.randomUUID().toString());
  ...
  public void testCopyResponse() {
    ...
    RpcResponse rpcResponse = RpcResponse.createJsonObject(UUID.randomUUID().toString(), Integer.parseInt(Randoms.randomNumber(5)),
        new JsonObject().put("foo", "bar"), Long.parseLong(Randoms.randomNumber(10)));
  ...
  public void testCopyJsonArrayResponse() {
    ...
    RpcResponse rpcResponse = RpcResponse.createJsonArray(UUID.randomUUID().toString(), Integer.parseInt(Randoms.randomNumber(5)),
        new JsonArray().add(1).add("2"), Long.parseLong(Randoms.randomNumber(10)));
